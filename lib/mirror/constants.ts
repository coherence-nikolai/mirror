...
export const PATTERN_LIBRARY: PatternMeta[] = [
  ...
  },
  {
    ...
    distortionLine: 'One signal may be crowding out another before both are heard.',
    timeOrientation: 'mixed',
    agencyState: 'available',
    baseIntensity: 0.44,
    bodyLocation: 'chest/belly',
    seen: 'More than one true signal is here.',
    shiftPhrase: 'Let both truths have some room.',
    microPractice: 'Name the first feeling, then the second.',
  },
  {
    id: 'tender',
  ...
  },
  {
    ...
    distortionLine: 'The mind may be trying to close what is still changing.',
    timeOrientation: 'mixed',
    agencyState: 'available',
    baseIntensity: 0.41,
    bodyLocation: 'chest',
    seen: 'You may be between states. Something is changing without being settled yet.',
    shiftPhrase: 'You do not need to force the crossing.',
    microPractice: 'Stand still for one breath. Let the shift keep moving.',
  },
  {
    id: 'disconnection',
