...
export const PATTERN_LIBRARY: PatternMeta[] = [
  ...
  },
  {
    ...
    distortionLine: 'The mind may be trying to settle this too quickly.',
    timeOrientation: 'mixed',
    agencyState: 'available',
    baseIntensity: 0.41,
    bodyLocation: 'chest',
    seen: 'What used to fit may not fit right now.',
    shiftPhrase: 'You do not need to decide what this is yet.',
    microPractice: 'One steady breath. Let this stay unfinished for a moment.',
  },
  {
    id: 'disconnection',
